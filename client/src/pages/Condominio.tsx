...
export function Condominio() {
  ...
  async function handleSalvarCondo(e: FormEvent) {
    ...
    try {
      ...
      setCondo({ ...atualizado, saldo: parseFloat(formCondo.saldo) });
      setEditando(false);
    } catch {
        ...
        {editando ? (
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              { label: 'Taxa mensal', valor: formatarMoeda(condo.taxaMensal) },
      ...
      <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
        ...
        {adicionandoFixa && (
          <form onSubmit={handleAdicionarFixa} className="mb-4 rounded-lg bg-blue-50 p-4">
            ...
            {erroFixa && (
              <p className="mb-2 text-xs text-red-600">{erroFixa}</p>
            )}
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <div className="mt-3 flex justify-end gap-2">
              <button
                type="button"
                onClick={() => { setAdicionandoFixa(false); setErroFixa(''); }}
            ...
            {fixas.map((fixa) => (
              <div key={fixa.id} className="flex items-center justify-between py-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => handleRemoverFixa(fixa.id, fixa.nome)}
